...
export default function CookiePolicyText() {
  return (
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8 leading-8 text-zinc-500 flex flex-col gap-10">
        ...
        <ul>
          <li>
            ...
            this Cookies Policy) refers to Shout Connect Ltd, Unit 1, Edward VII
        ...
        <h1 className="font-bold text-lg">The use of the Cookies</h1>
        <h2 className="font-bold text-base">Type of Cookies We Use</h2>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              ...
              social media networking website such as Facebook, Instagram,
              Twitter or Google+.
            </p>
          </li>
        </ul>
        <h2 className="font-bold text-base">Your Choices Regarding Cookies</h2>
        <p>
        ...
        <h2 className="font-bold text-base">More Information about Cookies</h2>
        <p>
        ...
        <ul>
          <li>
            <p>By email: cookies@shoutconnect.co.uk</p>
          </li>
          <li>
            <p>
              By mail: Unit 2, Edward VII Quay, Navigation Way,
