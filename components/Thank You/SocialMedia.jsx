  ...
  return (
    <div className="py-24 max-sm:py-16">
      <div className="px-6 mx-auto max-w-7xl lg:px-8 text-white flex max-md:flex-col max-md:gap-20 max-md:items-center max-md:justify-center justify-between">
        <div className="flex flex-col w-2/3 max-md:w-full max-md:text-center">
          ...
          <p className="text-lg mt-10">
            ...
            announcements about Preston City Games? Don't miss out on this
            opportunity, follow us today and stay up to date with all the latest
            happenings!
          </p>
        </div>
