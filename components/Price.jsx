  ...
  return (
    <div className="" id="register">
      ...
      <div className=" grid grid-cols-4 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6 max-sm:gap-8 ">
        ...
        >
          <p className="font-title text-4xl tracking-wide text-green-500 mb-2">
            Male Football
          </p>
          <div className="flex flex-auto flex-col items-center bg-neutral-50 rounded-lg overflow-hidden">
            ...
            <div className="px-4 text-slate-600 text-center">
              ...
              <div className="py-4 border-b-2 border-slate-200/80">
                ...
                <p>
                  Min. 5 players, Max. 8 players and at least 2 female players
                </p>
              </div>
        ...
        {/* <div
          ...
          className="  text-center hover:scale-105 max-sm:hover:scale-100"
        >
          <p className="font-title text-4xl tracking-wide text-[rgb(251,146,60)] mb-2">
            Netball
          </p>
          <div className="flex flex-auto flex-col items-center bg-neutral-50 rounded-lg overflow-hidden">
        ...
        {/* <div
          ...
          className="  text-center hover:scale-105 max-sm:hover:scale-100"
        >
          <p className="font-title text-4xl tracking-wide text-[rgb(192,132,252)] mb-2">
            Rounders
          </p>
          <div className="flex flex-auto flex-col items-center bg-neutral-50 rounded-lg overflow-hidden">
        ...
        {/* <div
          ...
          className="  text-center hover:scale-105 max-sm:hover:scale-100"
        >
          <p className="font-title text-4xl tracking-wide text-[rgb(125,211,252)] mb-2">
            Golf
          </p>
          <div className=" flex flex-auto flex-col items-center bg-neutral-50 rounded-lg overflow-hidden">
