...
export default function PrivacyPolicyText() {
  return (
    <div className="py-24 max-sm:py-16">
      <div className="px-6 mx-auto max-w-7xl lg:px-8 leading-8 text-zinc-500 flex flex-col gap-10">
        <p className="w-full text-right">Last updated: July 31, 2023</p>
        <p>
        ...
        <h1 className="font-bold text-lg">Interpretation and Definitions</h1>
        <h2 className="font-bold text-base">Interpretation</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Shout Connect Ltd, Unit 1, Edward VII
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Shout Connect, accessible from{" "}
              <a href="https://www.shoutconnect.co.uk/" target="_blank">
                www.shoutconnect.co.uk
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="font-bold text-base">Types of Data Collected</h2>
        <h3 className="font-bold text-base">Personal Data</h3>
        <p>
        ...
        <h3 className="font-bold text-base">Usage Data</h3>
        ...
        <h2 className="font-bold text-base">Use of Your Personal Data</h2>
        ...
        <h2 className="font-bold text-base">Retention of Your Personal Data</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Transfer of Your Personal Data</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Delete Your Personal Data</h2>
        <p>
        ...
        <h3 className="font-bold text-base">Business Transactions</h3>
        <p>
        ...
        <h3 className="font-bold text-base">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="font-bold text-base">Other legal requirements</h3>
        <p>
        ...
        <h2 className="font-bold text-base">Security of Your Personal Data</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Analytics</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Email Marketing</h2>
        <p>
        ...
        <h2 className="font-bold text-base">Behavioral Remarketing</h2>
        <p>
        ...
        <h1 className="font-bold text-lg">GDPR Privacy</h1>
        <h2 className="font-bold text-base">
        ...
        <h2 className="font-bold text-base">Your Rights under the GDPR</h2>
        <p>
        ...
        <h1 className="font-bold text-lg">Children's Privacy</h1>
        <p>
        ...
        <h1 className="font-bold text-lg">Links to Other Websites</h1>
        <p>
        ...
        <h1 className="font-bold text-lg">Changes to this Privacy Policy</h1>
        <p>
        ...
        <ul>
          <li>
            <p>By email: privacy@shoutconnect.co.uk</p>
          </li>
          <li>
            <p>
              By mail: Unit 1, Edward VII Quay, Navigation Way, Preston, PR2 2YF
            </p>
          </li>
        </ul>
      </div>
