  ...
  return (
    <div className="py-24 max-sm:py-16" id="venue">
      <div className="px-6 mx-auto max-w-7xl lg:px-8 flex flex-col gap-12">
        <h1 className=" max-lg:m-auto text-7xl max-xl:text-6xl max-md:text-5xl max-sm:text-4xl max-xl:leading-[65px] max-lg:text-center font-title text-white tracking-wide leading-[75px]">
          Venues for <br />
