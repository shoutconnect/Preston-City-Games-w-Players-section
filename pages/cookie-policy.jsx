...
export default function CookiePolicy() {
  return (
    <>
      <Head>
        <title>
          Cookie Policy | Preston City Games | Sporting festival in Preston, UK
        </title>
        <meta
          name="description"
          content="Cookie Policy | Preston City Games is a fun, one day sporting festival that pits teams of businesses and charities against each other in a tournament of rounders, football, netball and golf."
        />
